...
export const appCopy: Record<ResolvedLanguage, AppCopy> = {
  en: {
    ...
    text: {
      ...
      "Reasoning history policy": "Reasoning history policy",
      "Reasoning summary policy": "Reasoning summary policy",
      "Locked": "Locked",
      "Manual": "Manual",
  ...
  zh: {
    ...
    text: {
      ...
      "Responses compatibility": "Responses 兼容性",
      "Reasoning history policy": "推理历史策略",
      "Reasoning summary policy": "推理摘要策略",
