...
export const appCopy: Record<ResolvedLanguage, AppCopy> = {
  en: {
    ...
    text: {
      ...
      "ZCode is already running. Open ZCode > Settings > Model Settings and click Refresh to apply the latest configuration.": "ZCode is already running. Open ZCode > Settings > Model Settings and click Refresh to apply the latest configuration.",
      "ZCode did not close automatically. Quit it from its tray menu (right-click the tray icon and choose Quit).": "ZCode did not close automatically. Quit it from its tray menu (right-click the tray icon and choose Quit).",
      "This ZCode instance was started outside CCR. Exit it from its tray menu (right-click the tray icon and choose Quit).": "This ZCode instance was started outside CCR. Exit it from its tray menu (right-click the tray icon and choose Quit).",
      "Force quit ZCode?": "Force quit ZCode?",
      "Force quit": "Force quit",
      "Unsaved work may be lost.": "Unsaved work may be lost.",
      "This ZCode instance was started outside CCR.": "This ZCode instance was started outside CCR.",
      "Closing the ZCode window only sends it to the system tray.": "Closing the ZCode window only sends it to the system tray.",
      "Force quitting immediately ends ZCode and its child processes.": "Force quitting immediately ends ZCode and its child processes.",
      "ZCode could not be force quit. Close it in Task Manager and try again.": "ZCode could not be force quit. Close it in Task Manager and try again.",
      "ZCode could not be force quit. Close it in Activity Monitor and try again.": "ZCode could not be force quit. Close it in Activity Monitor and try again.",
      "ZCode could not be force quit. Close it in your system monitor and try again.": "ZCode could not be force quit. Close it in your system monitor and try again.",
      "CCR could not identify the ZCode process.": "CCR could not identify the ZCode process.",
      "The system rejected the force-quit command.": "The system rejected the force-quit command.",
      "ZCode is still running after the force-quit command.": "ZCode is still running after the force-quit command.",
      "Exit code": "Exit code",
  ...
  zh: {
    ...
    text: {
      ...
      "ZCode is already running. Open ZCode > Settings > Model Settings and click Refresh to apply the latest configuration.": "ZCode 已在运行。请在 ZCode 中打开「设置 → 模型设置」，点击「刷新」以应用最新配置。",
      "ZCode did not close automatically. Quit it from its tray menu (right-click the tray icon and choose Quit).": "ZCode 未能自动关闭，请在状态栏右键点击 ZCode 图标选择「退出」。",
      "This ZCode instance was started outside CCR. Exit it from its tray menu (right-click the tray icon and choose Quit).": "该 ZCode 由用户自行启动，CCR 不做终止。请在状态栏右键点击 ZCode 图标选择「退出」。",
      "Force quit ZCode?": "强制退出 ZCode？",
      "Force quit": "强制退出",
      "Unsaved work may be lost.": "未保存的内容可能会丢失。",
      "This ZCode instance was started outside CCR.": "该 ZCode 不是由 CCR 启动的。",
      "Closing the ZCode window only sends it to the system tray.": "关闭 ZCode 窗口只会将它收起到系统托盘。",
      "Force quitting immediately ends ZCode and its child processes.": "强制退出会立即结束 ZCode 及其子进程。",
      "ZCode could not be force quit. Close it in Task Manager and try again.": "无法强制退出 ZCode，请在任务管理器中结束它后重试。",
      "ZCode could not be force quit. Close it in Activity Monitor and try again.": "无法强制退出 ZCode，请在活动监视器中结束它后重试。",
      "ZCode could not be force quit. Close it in your system monitor and try again.": "无法强制退出 ZCode，请在系统监视器中结束它后重试。",
      "CCR could not identify the ZCode process.": "CCR 无法识别 ZCode 进程。",
      "The system rejected the force-quit command.": "系统未能执行强制退出命令。",
      "ZCode is still running after the force-quit command.": "已发送强制退出命令，但 ZCode 仍在运行。",
      "Exit code": "退出码",
      "System message": "系统信息",
