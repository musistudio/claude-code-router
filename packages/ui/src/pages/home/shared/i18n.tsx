...
export const appCopy: Record<ResolvedLanguage, AppCopy> = {
  en: {
    ...
    text: {
      ...
      "After login, copy the returned tokens into the fields above.": "After login, copy the returned tokens into the fields above.",
      "Cloud server URL": "Cloud server URL",
      "Cloud Sync": "Cloud Sync",
      "Cloud account": "Cloud account",
      "Cloud encrypted snapshot was decrypted successfully.": "Cloud encrypted snapshot was decrypted successfully.",
      "Cloud encrypted snapshot was pulled and applied.": "Cloud encrypted snapshot was pulled and applied.",
      "Cloud sync has no remote snapshot yet.": "Cloud sync has no remote snapshot yet.",
      "Cloud sync found conflicting changes that require your confirmation.": "Cloud sync found conflicting changes that require your confirmation.",
      "Cloud sync conflict expired or is no longer available. Sync again to refresh it.": "Cloud sync conflict expired or is no longer available. Sync again to refresh it.",
      "Cloud sync is disabled on this device.": "Cloud sync is disabled on this device.",
      "Cloud sync is enabled and the local encrypted snapshot was uploaded.": "Cloud sync is enabled and the local encrypted snapshot was uploaded.",
      "Cloud sync is enabled and the remote encrypted snapshot was restored on this device.": "Cloud sync is enabled and the remote encrypted snapshot was restored on this device.",
      "Cloud sync is only available in the Electron app.": "Cloud sync is only available in the Electron app.",
      "Cloud sync key file generation is only available in the desktop app.": "Cloud sync key file generation is only available in the desktop app.",
      "Cloud sync login is only available in the desktop app.": "Cloud sync login is only available in the desktop app.",
      "Cloud sync login expired. Sign in again.": "Cloud sync login expired. Sign in again.",
      "Cloud sync received changes while local edits were pending. Reload the latest configuration before editing again.": "Cloud sync received changes while local edits were pending. Reload the latest configuration before editing again.",
      "The cloud sync encryption key changed on another device. Unlock sync with the new password or key file.": "The cloud sync encryption key changed on another device. Unlock sync with the new password or key file.",
      "Cloud conflict was resolved using cloud values.": "Cloud conflict was resolved using cloud values.",
      "Cloud conflict was resolved using cloud values and independent local changes were pushed.": "Cloud conflict was resolved using cloud values and independent local changes were pushed.",
      "Cloud conflict was resolved using local values and the merged snapshot was pushed.": "Cloud conflict was resolved using local values and the merged snapshot was pushed.",
      "Cloud conflict was resolved using the reviewed values.": "Cloud conflict was resolved using the reviewed values.",
      "Cloud conflict was resolved using the reviewed values and the merged snapshot was pushed.": "Cloud conflict was resolved using the reviewed values and the merged snapshot was pushed.",
      "Local configuration changed after the conflict was detected. Sync again before choosing a version.": "Local configuration changed after the conflict was detected. Sync again before choosing a version.",
      "Cloud sync is paused because conflicting changes require confirmation.": "Cloud sync is paused because conflicting changes require confirmation.",
      "Choose which side should win for the listed fields. Independent changes from both sides will still be preserved.": "Choose which side should win for the listed fields. Independent changes from both sides will still be preserved.",
      "Review the left and right values, then confirm or edit the final JSON result in the middle. Independent changes from both sides will still be preserved.": "Review the left and right values, then confirm or edit the final JSON result in the middle. Independent changes from both sides will still be preserved.",
      "Each final result is JSON. Strings must remain quoted.": "Each final result is JSON. Strings must remain quoted.",
      "Conflicting paths": "Conflicting paths",
      "Decide later": "Decide later",
      "Resolve cloud sync conflict": "Resolve cloud sync conflict",
      "Resolved conflict paths:": "Resolved conflict paths:",
      "Review conflict": "Review conflict",
      "The same configuration fields changed locally and in the cloud.": "The same configuration fields changed locally and in the cloud.",
      "Use all cloud values": "Use all cloud values",
      "Use all local values": "Use all local values",
      "Use cloud values": "Use cloud values",
      "Use local values": "Use local values",
      "Local value": "Local value",
      "Cloud value": "Cloud value",
      "Use local value": "Use local value",
      "Use cloud value": "Use cloud value",
      "Use local": "Use local",
      "Use cloud": "Use cloud",
      "Final result": "Final result",
      "Cloud": "Cloud",
      "Remove field": "Remove field",
      "Keep field": "Keep field",
      "Field does not exist": "Field does not exist",
      "This field will be removed from the merged configuration.": "This field will be removed from the merged configuration.",
      "Resolve every conflicting field before applying.": "Resolve every conflicting field before applying.",
      "The final result for {path} must be valid JSON.": "The final result for {path} must be valid JSON.",
      "Apply resolution": "Apply resolution",
      "Cloud configuration restored. Review it before entering CCR.": "Cloud configuration restored. Review it before entering CCR.",
      "Cloud login completed. Choose the encryption method used by your cloud snapshot.": "Cloud login completed. Choose the encryption method used by your cloud snapshot.",
      "Cloud login completed. Choose an encryption method to enable sync.": "Cloud login completed. Choose an encryption method to enable sync.",
      "Choose an E2EE key file": "Choose an E2EE key file",
      "Choose key file": "Choose key file",
      "Choose what this device restores and continues to sync. All items are selected by default.": "Choose what this device restores and continues to sync. All items are selected by default.",
      "Choose what this device syncs. All items are selected by default.": "Choose what this device syncs. All items are selected by default.",
      "Clear all": "Clear all",
      "Complete login in the browser, then return to CCR.": "Complete login in the browser, then return to CCR.",
      "Create the key file if it does not exist": "Create the key file if it does not exist",
      "Device ID": "Device ID",
      ...
      "End-to-end encryption is required before cloud sync can be enabled.": "End-to-end encryption is required before cloud sync can be enabled.",
      "Key file": "Key file",
      "Key file generated. Keep it safe; losing it can make cloud data unrecoverable.": "Key file generated. Keep it safe; losing it can make cloud data unrecoverable.",
      "Key file path": "Key file path",
      "Key mode": "Key mode",
      "Last sync": "Last sync",
      "Local configuration was encrypted and pushed to cloud sync.": "Local configuration was encrypted and pushed to cloud sync.",
      "Local values were kept for these conflict paths:": "Local values were kept for these conflict paths:",
      "Never": "Never",
      "Not registered": "Not registered",
      "Not set": "Not set",
      "Open GitHub login": "Open GitHub login",
      "Open the browser to complete cloud sync login.": "Open the browser to complete cloud sync login.",
      "Optional path to an E2EE key file": "Optional path to an E2EE key file",
      "Password": "Password",
      "Paste the GitHub OAuth access token returned by CCR Cloud.": "Paste the GitHub OAuth access token returned by CCR Cloud.",
      "Paste the refresh token to allow automatic token rotation.": "Paste the refresh token to allow automatic token rotation.",
      "Pull": "Pull",
      "Pull cloud config": "Pull cloud config",
      "Push": "Push",
      "Refresh token": "Refresh token",
      "Generate key file": "Generate key file",
      "Required unless you use a key file": "Required unless you use a key file",
      "Restore from cloud": "Restore from cloud",
      "Hide restore options": "Hide restore options",
      "Revision": "Revision",
      ...
      "Select at least one sync item.": "Select at least one sync item.",
      "Agent Profile": "Agent Profile",
      ...
      "Provider": "Provider",
      "Sync the latest 5,000 usage records.": "Sync the latest 5,000 usage records.",
      "ToolHub": "ToolHub",
      "Tray": "Tray",
      "Usage statistics": "Usage statistics",
      "Sync providers, agent profiles, routing rules, plugins, ToolHub, and related user configuration as encrypted snapshots.": "Sync providers, agent profiles, routing rules, plugins, ToolHub, and related user configuration as encrypted snapshots.",
      ...
      "Use an encrypted cloud snapshot instead of setting up providers manually.": "Use an encrypted cloud snapshot instead of setting up providers manually.",
      "Use the same password or key file that encrypted your cloud snapshot. Losing it makes cloud data unrecoverable.": "Use the same password or key file that encrypted your cloud snapshot. Losing it makes cloud data unrecoverable.",
      "Using key file": "Using key file",
      "Your password or key file is never uploaded. If you forget the password or lose the key file, cloud data cannot be decrypted and may be permanently lost.": "Your password or key file is never uploaded. If you forget the password or lose the key file, cloud data cannot be decrypted and may be permanently lost.",
  ...
  zh: {
    ...
    text: {
      ...
      "App surface": "App 运行面",
      "Access token": "访问令牌",
      "After login, copy the returned tokens into the fields above.": "登录后，将返回的 token 复制到上方字段。",
      "Cloud server URL": "云端服务地址",
      "Cloud Sync": "云同步",
      "Cloud account": "云端账号",
      "Cloud encrypted snapshot was decrypted successfully.": "云端加密快照已成功解密。",
      "Cloud encrypted snapshot was pulled and applied.": "云端加密快照已拉取并应用。",
      "Cloud sync has no remote snapshot yet.": "云端还没有可同步的快照。",
      "Cloud sync found conflicting changes that require your confirmation.": "检测到风险冲突，需要你确认采用本地值还是云端值。",
      "Cloud sync conflict expired or is no longer available. Sync again to refresh it.": "云同步冲突已过期或不可用，请重新同步以刷新冲突状态。",
      "Cloud sync is disabled on this device.": "这台设备上的云同步已禁用。",
      "Cloud sync is enabled and the local encrypted snapshot was uploaded.": "云同步已启用，本地加密快照已上传。",
      "Cloud sync is enabled and the remote encrypted snapshot was restored on this device.": "云同步已启用，云端加密快照已恢复到这台设备。",
      "Cloud sync is only available in the Electron app.": "云同步仅在 Electron 应用中可用。",
      "Cloud sync key file generation is only available in the desktop app.": "云同步 key 文件生成仅在桌面应用中可用。",
      "Cloud sync login is only available in the desktop app.": "云同步登录仅在桌面应用中可用。",
      "Cloud sync login expired. Sign in again.": "云同步登录已过期，请重新登录。",
      "Cloud sync received changes while local edits were pending. Reload the latest configuration before editing again.": "本地仍有待保存修改时收到了云同步更新，请先重新加载最新配置再继续编辑。",
      "The cloud sync encryption key changed on another device. Unlock sync with the new password or key file.": "另一台设备已更换云同步加密密钥，请使用新密码或密钥文件解锁同步。",
      "Cloud conflict was resolved using cloud values.": "已使用云端值解决冲突。",
      "Cloud conflict was resolved using cloud values and independent local changes were pushed.": "已使用云端值解决冲突，并上传了本地的独立修改。",
      "Cloud conflict was resolved using local values and the merged snapshot was pushed.": "已使用本地值解决冲突并上传合并结果。",
      "Cloud conflict was resolved using the reviewed values.": "已使用确认后的最终结果解决冲突。",
      "Cloud conflict was resolved using the reviewed values and the merged snapshot was pushed.": "已使用确认后的最终结果解决冲突并上传合并快照。",
      "Local configuration changed after the conflict was detected. Sync again before choosing a version.": "检测到冲突后本地配置又发生了变化，请重新同步后再选择版本。",
      "Cloud sync is paused because conflicting changes require confirmation.": "云同步已暂停，因为冲突变更需要你确认。",
      "Choose which side should win for the listed fields. Independent changes from both sides will still be preserved.": "请选择冲突字段采用哪一侧的值；双方互不冲突的修改仍会保留。",
      "Review the left and right values, then confirm or edit the final JSON result in the middle. Independent changes from both sides will still be preserved.": "请对比左侧本地值与右侧云端值，然后确认或编辑中间的最终 JSON 结果；双方互不冲突的修改仍会保留。",
      "Each final result is JSON. Strings must remain quoted.": "每个最终结果都是 JSON，字符串需要保留引号。",
      "Conflicting paths": "冲突字段",
      "Decide later": "稍后决定",
      "Resolve cloud sync conflict": "解决云同步冲突",
      "Resolved conflict paths:": "已解决的冲突字段：",
      "Review conflict": "查看冲突",
      "The same configuration fields changed locally and in the cloud.": "相同的配置字段在本地和云端都发生了修改。",
      "Use all cloud values": "全部使用云端值",
      "Use all local values": "全部使用本地值",
      "Use cloud values": "使用云端值",
      "Use local values": "使用本地值",
      "Local value": "本地值",
      "Cloud value": "云端值",
      "Use local value": "使用本地值",
      "Use cloud value": "使用云端值",
      "Use local": "使用本地",
      "Use cloud": "使用云端",
      "Final result": "最终结果",
      "Cloud": "云端",
      ...
      "This field will be removed from the merged configuration.": "该字段将从合并后的配置中删除。",
      "Resolve every conflicting field before applying.": "应用前请处理所有冲突字段。",
      "The final result for {path} must be valid JSON.": "{path} 的最终结果必须是有效 JSON。",
      "Apply resolution": "应用合并结果",
      "Cloud configuration restored. Review it before entering CCR.": "云端配置已恢复。进入 CCR 前请确认配置。",
      "Cloud login completed. Choose the encryption method used by your cloud snapshot.": "云端登录已完成。请选择云端快照使用的加密方式。",
      "Cloud login completed. Choose an encryption method to enable sync.": "云端登录已完成。请选择加密方式以启用同步。",
      "Choose an E2EE key file": "选择端到端加密 key 文件",
      "Choose key file": "选择 key 文件",
      "Choose what this device restores and continues to sync. All items are selected by default.": "选择这台设备要恢复并继续同步的内容。默认全部选中。",
      "Choose what this device syncs. All items are selected by default.": "选择这台设备要同步的内容。默认全部选中。",
      "Clear all": "清空",
      "Complete login in the browser, then return to CCR.": "请在浏览器中完成登录，然后回到 CCR。",
      ...
      "Create the key file if it does not exist": "如果 key 文件不存在则创建",
      ...
      "End-to-end encryption is required before cloud sync can be enabled.": "启用云同步前必须先设置端到端加密。",
      "Export": "导出",
      "Export data": "导出数据",
      ...
      "Exporting": "正在导出",
      "Key file": "key 文件",
      "Key file generated. Keep it safe; losing it can make cloud data unrecoverable.": "key 文件已生成。请妥善保存；丢失后云端数据可能无法恢复。",
      "Key file path": "key 文件路径",
      "Key mode": "密钥模式",
      "Last sync": "上次同步",
      "Local configuration was encrypted and pushed to cloud sync.": "本地配置已加密并推送到云同步。",
      "Local values were kept for these conflict paths:": "以下冲突路径已保留本地值：",
      "Not registered": "未注册",
      "Open GitHub login": "打开 GitHub 登录",
      "Open the browser to complete cloud sync login.": "请打开浏览器完成云同步登录。",
      "Optional path to an E2EE key file": "可选的端到端加密 key 文件路径",
      "Paste the GitHub OAuth access token returned by CCR Cloud.": "粘贴 CCR Cloud 返回的 GitHub OAuth access token。",
      "Paste the refresh token to allow automatic token rotation.": "粘贴 refresh token，以便自动轮换访问令牌。",
      "Pull": "拉取",
      "Pull cloud config": "拉取云端配置",
      "Push": "推送",
      "Refresh token": "刷新令牌",
      "Generate key file": "生成 key 文件",
      "Required unless you use a key file": "不使用 key 文件时必填",
      "Request log database": "请求日志数据库",
      "Restore from cloud": "从云端恢复",
      "Hide restore options": "收起恢复选项",
      "Revision": "版本",
      "State": "状态",
      ...
      "Sync range": "同步范围",
      "Select all": "全选",
      "Select at least one sync item.": "请至少选择一项同步内容。",
      "Agent Profile": "Agent Profile",
      "Appearance settings": "外观配置",
      "API keys": "API 密钥",
      "Fusion": "Fusion",
      "Overview configuration": "概览页配置",
      "Sync the latest 5,000 usage records.": "同步最近 5,000 条 Usage 统计记录。",
      "ToolHub": "ToolHub",
      "Tray": "Tray",
      "Usage statistics": "Usage 统计",
      "Sync providers, agent profiles, routing rules, plugins, ToolHub, and related user configuration as encrypted snapshots.": "将 Providers、Agent Profiles、路由规则、插件、ToolHub 等用户配置作为加密快照同步。",
      "This device": "这台设备",
      "Unlocked": "已解锁",
      "Update setup": "更新设置",
      "Unlock sync": "解锁同步",
      "Rotate encryption key": "轮换加密密钥",
      "Sensitive value hidden": "敏感值已隐藏",
      "Use an encrypted cloud snapshot instead of setting up providers manually.": "使用云端加密快照恢复配置，无需手动设置 Provider。",
      "Use the same password or key file that encrypted your cloud snapshot. Losing it makes cloud data unrecoverable.": "请使用加密云端快照时的同一个密码或 key 文件。丢失后云端数据将无法恢复。",
      "Using key file": "正在使用 key 文件",
      "Your password or key file is never uploaded. If you forget the password or lose the key file, cloud data cannot be decrypted and may be permanently lost.": "密码或 key 文件不会上传。忘记密码或丢失 key 文件后，云端数据将无法解密，并可能永久丢失。",
      "Method": "方法",
      "Model": "模型",
      "Default model": "默认模型",
