...
export const appCopy: Record<ResolvedLanguage, AppCopy> = {
  en: {
    ...
    text: {
      ...
      "Search the web with a configured provider. Xquik searches recent X posts.": "Search the web with a configured provider. Xquik searches recent X posts.",
      "Search the web with the in-app browser or a configured provider. Xquik searches recent X posts.": "Search the web with the in-app browser or a configured provider. Xquik searches recent X posts.",
  ...
  zh: {
    ...
    text: {
      ...
      "Search the web with a configured provider. Xquik searches recent X posts.": "通过已配置的服务搜索网络。Xquik 用于搜索 X 上的近期帖子。",
      "Search the web with the in-app browser or a configured provider. Xquik searches recent X posts.": "通过内置浏览器或已配置的服务搜索网络。Xquik 用于搜索 X 上的近期帖子。",
