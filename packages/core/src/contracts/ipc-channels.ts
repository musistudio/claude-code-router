export const IPC_CHANNELS = {
  ...
  appCloudSyncDisable: "ccr:app:cloud-sync-disable",
  appCloudSyncAuthChanged: "ccr:app:cloud-sync-auth-changed",
  appCloudSyncChanged: "ccr:app:cloud-sync-changed",
  appCloudSyncGenerateKeyFile: "ccr:app:cloud-sync-generate-key-file",
  appCloudSyncGetStatus: "ccr:app:cloud-sync-get-status",
  appCloudSyncLogin: "ccr:app:cloud-sync-login",
  appCloudSyncLogout: "ccr:app:cloud-sync-logout",
  ...
  appCloudSyncRotateKey: "ccr:app:cloud-sync-rotate-key",
