                    ...
                    {vertexCredentials.credentialMode === 'file' && (
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setVertexCredentials(prev => ({ ...prev, keyFile: e.target.value }))}
                        />
                      </div>
                    )}
                    ...
                    {vertexCredentials.credentialMode === 'json' && (
                      <div className="space-y-2">
                        ...
                        <textarea
                          ...
                          onChange={(e) => setVertexCredentials(prev => ({ ...prev, keyJson: e.target.value }))}
                        />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setVertexCredentials(prev => ({ ...prev, project: e.target.value }))}
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setVertexCredentials(prev => ({ ...prev, location: e.target.value }))}
                        />
                      </div>
                    </div>
                  </div>
